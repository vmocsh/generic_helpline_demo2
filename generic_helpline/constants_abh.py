...
STATIC_URL_APPEND = '/'
URL_APPEND = ''
HELPLINE_NAME = 'Abhyuday Helpline'

# IVRS 
ALL_LANGUAGES = ['Hindi', 'Marathi', 'Gujarati', 'English']
CATEGORIES = ['Maths', 'Biology', 'Commerce', 'Arts', 'Others']
SUBCATEGORIES = [[], [], [], []]
